...
class Dhaatu:
    def __init__(self,data):
        ...
        if inp_data[-1]=='NN' and inp_data[-2]=='a':
            self._data = ''.join(inp_data[0:-2]+['NN'])
        else:
            self._data= data
...
def get_dhaatu_properties_dict():
    ...
    dhaatu_store= dict((Dhaatu(k)._data,v) for k,v in dhaatu_store.items())
    return dhaatu_store
